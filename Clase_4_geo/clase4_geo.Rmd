...
sannic <- nominatimlite::geo_lite_sf(address = "San Nicolas, Ciudad autonoma de Buenos aires, Argentina", points_only = FALSE)

pmad <- nominatimlite::geo_lite_sf(address = "Puerto Madero, Ciudad autonoma de Buenos aires, Argentina", points_only = FALSE)

santelmo <- nominatimlite::geo_lite_sf(address = "San Telmo, Ciudad autonoma de Buenos aires, Argentina", points_only = FALSE)
...
sannics_calles <- st_intersection(sannics_calles$osm_lines, sannic)

pmad_calles <- st_intersection(pmad_calles$osm_lines, pmad)

santelmo_calles <- st_intersection(santelmo_calles$osm_lines, santelmo)
...
ggplot()+
  geom_sf(data = SANNICOLAS_calle)+
  geom_sf(data =  SANTELMO_calle)+
  geom_sf(data = MONSERRAT_calle)+
  geom_sf(data = PUERTOMADERO_calle)+
