...
vclient_id='60e745a216294723b27f83ff2a6e13b9'
vclient_secret= '358a4D45EECa42EF954Ff8eB492A37B5'

tokens = list(vclient_id='60e745a216294723b27f83ff2a6e13b9',
vclient_secret= '358a4D45EECa42EF954Ff8eB492A37B5')
...
rutas <- read.table("colectivos/stops.txt", sep= ",", header=T)


stop_times <-  read.table("colectivos/stop_times.txt", sep= ",", header=T)
...
# subtes alerta
#df$entity.alert$description_text$translation[[1]][1,1]
